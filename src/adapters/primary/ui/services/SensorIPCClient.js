...
class SensorIPCClient {
  ...
  async initialize() {
    ...
    try {
      ...
      console.log('[SensorClient] ✓ Client IPC initialisé');
      return true;
  ...
  async startScanning() {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.log('[SensorClient] ✓ Scan démarré');
      } else {
  ...
  async stopScanning() {
    ...
    try {
      ...
      if (result.success) {
        this.isScanning = false;
        console.log('[SensorClient] ✓ Scan arrêté');
      } else {
  ...
  async cleanup() {
    ...
    try {
      ...
      console.log('[SensorClient] ✓ Nettoyage terminé');
